# A minimal docker baseimage to ease creation of X graphical application containers that runs on arm
This is a fork of https://github.com/jlesage/docker-baseimage-gui
